...
export default class AlunoModel {
    ...
    static async buscarTodos(filtros = {}) {
        ...
        if (filtros.escola !== undefined) where.escola = { contains: filtros.escola, mode: 'insensitive' };
        if (filtros.turma !== undefined)where.turma = { contains: filtros.turma, mode: 'insensitive' };;
